...
function Auth() {
    ...
    const registerClicked = () => {
        if (first_name === '' && last_name === '' && address === '' && city === '' && zip_code === '' && country === '' && email === '' && username === '' && password === '' && password2 === '') {
            setAlertView(false)
        ...
        <Form className="login-form">
            {isLoginView ?
                <div>
                    ...
                    <span><p>or</p></span>
                    <p style={{ color: "green" }} onClick={() => setIsLoginView(false)}>Create new account</p>
                </div>
                :
                <div>
                    <img src={logo} height="150" width="150" />
                    ...
                    <FormGroup>
                        <Input type="text" name="address" id="Address" placeholder="Address eg:1234 Main St" value={address}
                    ...
                    <Row form>
                        ...
                        <Col md={3}>
                            <FormGroup>
                                <Input type="text" name="zip_code" id="Zip_Code" placeholder="Zip eg:12345" value={zip_code}
                    ...
                    <span><p>or</p></span>
                    <p style={{ color: "green" }} onClick={() => setIsLoginView(true)}>Login here!</p>
                </div>}
        </Form >
    );
}
